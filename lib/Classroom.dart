...
// Function to generate a new, unique ID
  int getNewUniqueId() {
    ...
    do {
      newId = Random()
        ...
        uniqueIds.contains(newId)); // check if the ID is already in the set
  ...
  void createClassroom(String? classNumber, String? classSection,
      String? classSubject, String? classMonitor) {
    id = getNewUniqueId().toString();
    className = "Class - $classNumber";
    createdAt = DateTime.now();
    ownerId = AuthServices.firebase().currentUser.toString();
    showButton = true;
  }
}
