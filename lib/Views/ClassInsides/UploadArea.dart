...
class _UploadAreaState extends State<UploadArea> {
  ...
  Widget build(BuildContext context) {
    ...
    final FilePickerResult selectedFile = arguments["filePickerResult"];
    final String classId = arguments["classId"];
            ...
            Row(
              ...
              children: [
                ...
                Expanded(
                    child: ElevatedButton(
                        onPressed: () async {
                          final result = await uploadToCloudinary(selectedFile,classId);
                          if (result) {
